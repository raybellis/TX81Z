...
ME231			FCB	SYX,MFR_YAMAHA,$03,$00,$5D
...
MIDI_SEND_EOX		LDAA	MIDI_CRC		; get running CRC
			NEGA				; negate it
...
MIDI_SEND		LDX	PTR_TX_TAIL		; get MIDI TX pointer
			STAA	,X			; store data
			CPX	#MIDI_TXBUF_END		; check if we're at buffer end
