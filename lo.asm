...
F_934A			PSHA
			...
			LDX	#$1770		; FIXME #6000
			BRA	Z935A
Z9357			LDX	#$12C		; FIXME #300
Z935A			LDAB	#$1E		; FIXME #30
			BRN	Z935E
Z935E			NOP
			DES
			BSR	F_936A
...
F_98BA			LDAB	#$1E		; FIXME #30
F_98BC			LDX	#$1194		; FIXME #4500
Z98BF			DEX
			BNE	Z98BF
			DECB
			BNE	F_98BC
...
F_9BFA			CLR	>M00AB
			CLR	>M00AC
Z9C00			SUBD	#$03E8		; FIXME #1000
			BCS	Z9C0A
			INC	>M00AB
			BRA	Z9C00
Z9C0A			ADDD	#$03E8		; FIXME #1000
Z9C0D			SUBD	#$64		; FIXME #100
			BCS	Z9C17
			INC	>M00AC
			BRA	Z9C0D
Z9C17			ADDD	#$64		; FIXME #100
			PSHB
			LDAA	M00AB
			LDAB	#$0A
			MUL
...
F_9C2A			PSHA
			PSHB
			CLR	>M00AB
Z9C2F			SUBD	#$2710		; FIXME #10000
			BCS	Z9C39
			INC	>M00AB
			BRA	Z9C2F
Z9C39			ADDD	#$2710		; FIXME #10000
			XGDX
			LDAA	M00AB
			BEQ	Z9C46
			JSR	F_9BD7
...
F_9C9F			CLR	>M00AC
Z9CA2			SUBD	#$64		; FIXME #100
			BCS	Z9CAC
			INC	>M00AC
			BRA	Z9CA2
Z9CAC			ADDD	#$64		; FIXME #100
			PSHB
			LDAA	M00AC
			JSR	F_9BD7
			PULA
...
F_B4D6			LDAB	#$C8		; FIXME #200
			MUL
			RTS

F_B4DA			LDAB	#$8E		; FIXME #142
			MUL
			RTS

F_B4DE			LDAB	#$26		; FIXME #38
			MUL
			RTS
