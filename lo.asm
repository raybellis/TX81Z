...
;-------
;
; Copy B bytes from @(0xa9) to @(X)
;
MEMCPY_xB_A9_X		STX	M00A7

;-------		fallthrough
;
; Copy B bytes from @(0xA9) to @(0xA7)
;
MEMCPY_xB_A9_A7
0			LDX	M00A9
			LDAA	,X
...
J9D21			RTS				; case 3, 7, 8, 11, 12, 13,
							;      15, 16, 19, 20, 21

Z9D22			JMP	Z9EEC			; case 1
J9D25			JMP	Z9EC0			; case 2
J9D28			JMP	Z9E61			; case 0
J9D2B			JMP	Z9E2F			; case 9, 17
J9D2E			JSR	F_B1CE			; case 4
			LDAB	#$02
			STAB	M7787
			TST	>M00A5
			BEQ	Z9D46
...
Z9D94			LDAB	#'P'			; case 14
			...
			JSR	F_9BD1
Z9DCE			BRA	Z9E13
J9DD0			LDAB	#'P'			; case 22
			JSR	F_9CD0
			JSR	PUTCHAR
			LDX	#S_ERFORMANCE_MODE
			BRA	Z9E21
Z9DDD			LDAB	#'P'			; case 10
			JSR	F_9CBF
			JSR	PUTCHAR
			LDX	#S_LAY_SINGLE
			JSR	PUTSTRX
			...
			STX	M00A7
			JSR	F_AF7D
Z9E13			JMP	LCD_UPDATE
J9E16			LDAB	#'P'			; case 18
			JSR	F_9CBF
			JSR	PUTCHAR
			LDX	#S_LAY_SINGLE
Z9E21			JSR	PUTSTRX
...
MA74A			LDX	#LCD_BUFFER + 29
			STX	M00A7
			LDAB	M7789
			ADDB	#$3C
			JSR	F_B43F
			JMP	LCD_UPDATE
MA75A			LDX	#LCD_BUFFER + 28
			STX	M00A7
			LDX	#DVEC_A76C
			LDAB	M777E
			ASLB
...
MAD2E_via_dvec_a7ac	FCC	"   /	/   /	~"
			FCB	$13
MAD3F_via_dvec_a7ae	FCB	CH_LEFT
			FCC	"   /	/   /	"
			FCB	$14
S_P_UT			FCC	"P.UT"
			FCB	$00
...
ZAFFA			CMPB	#$05
			...
			CMPB	#$08
			BNE	ZB013
ZB006			LDX	#LCD_BUFFER + 6
			STX	M00A7
			LDX	#S_1_2_3_4
			JSR	PUTSTRX
			BRA	ZB079
ZB013			LDX	#LCD_BUFFER + 7
			STX	M00A7
			LDX	#S_ALG
			JSR	PUTSTRX
			JSR	F_B53E
...
JB048			LDX	#S_LFO_EDIT
			BRA	ZB076
JB04D			LDX	#S_SENS_EDIT
			BRA	ZB076
JB052			LDX	#S_FREQ
			BRA	ZB061
JB057			LDX	#S_1_2_3_4
			BRA	ZB076
JB05C			LDX	#S_FUNCTION
			BRA	ZB076
ZB061			JSR	PUTSTRX
			LDX	#$4F50
			STX	LCD_BUFFER + 13
...
JB193			SUBB	#$29
			BRA	ZB199
JB197			SUBB	#$2A
ZB199			LDX	#LCD_BUFFER + 5
ZB19C			STX	M00A7
			LDX	#DVEC_B1BA
			JMP	ZB0E5
JB1A4			LDX	#LCD_BUFFER + 5
			STX	M00A7
			LDAA	M778C
			CMPA	#$08
			BCS	ZB1B1
...
JB26B			LDD	#$3400
			...
			JSR	PUTSTRX
			BRA	ZB2DF
JB27E			LDX	#LCD_BUFFER + 8
			STX	M00A7
			LDX	#S_ALG_4
			JSR	PUTSTRX
			CLR	LCD_BUFFER + 11
ZB28C			LDX	#LCD_BUFFER + 26
			STX	M00A7
			LDX	#S_ALG_5
			JSR	PUTSTRX
			BRA	ZB2DF
JB299			LDX	#LCD_BUFFER + 10
			STX	M00A7
			LDX	#S_ALG_6
			JSR	PUTSTRX
			BRA	ZB28C
